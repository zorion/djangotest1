...
# Tutorial05: https://docs.djangoproject.com/en/1.6/intro/tutorial05/
# PollMethodTests is a subclass of django.test.TestCase
class PollMethodTests(TestCase):

	def test_was_published_recently_with_future_poll(self):
		"""
		was_published_recently() should return False for polls whose
		pub_data is in the future
		"""
	...
	def test_was_published_recently_with_recent_poll(self):
		...
		pub_data is within the last 2 days
		"""
...
class PollIndexViewTests(TestCase):
	...
	def test_index_view_with_a_past_poll(self):
		"""
		Polls with a pub_data in the past should be displayed on the index page.
		"""
	...
	def test_index_view_with_a_future_poll(self):
		"""
		Polls with a pub_data in the future should not be displayed on the
		index page.
		"""
	...
	def test_index_view_with_two_past_polls(self):
		...
		response = self.client.get(reverse('polls:index'))
		self.assertQuerysetEqual(
			qs=response.context['latest_poll_list'],
			values=['<Poll: Past poll 2.>', '<Poll: Past poll 1.>'],
			#ordered=False,
		)
...
class PollDetailViewTests(TestCase):
	def test_detail_view_with_a_future_poll(self):
		"""
		The detail view of a poll with a pub_data in the future should
	...
	def test_detail_view_with_a_past_poll(self):
		"""
		The detail view of a poll with a pub_data in the past
		"""
		past_poll=create_poll("Past Poll.",-1)
